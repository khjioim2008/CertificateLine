...
//内存池(32字节对齐)
__align(32) u8 mem1base[10];													//内部SRAM内存池
__align(32) u8 mem2base[10] __attribute__((at(0X68000000)));					//外部SRAM内存池
__align(32) u8 mem3base[10] __attribute__((at(0X10000000)));					//内部CCM内存池
//内存管理表
